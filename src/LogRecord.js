...
import * as Utils from './LevelUtils'
...
export default class LogRecord {
  ...
  constructor (type:RecordType, data:Slice) {
    this.type = type
    this.data = data
  }
  ...
  get buffer ():Buffer {
    const lengthBuf = Buffer.from(Utils.createHexStringFromDecimal(this.data.length), 'hex')
